                                  ...
                                  children: [
                                    Container(
                                        ...
                                        margin: EdgeInsets.only(
                                            left: 3.h, bottom: 1.v),
                                        child: Text(
                                            "There is no order sheduled for \ntomorrow",
                                            maxLines: 2,
                                    ...
                                    CustomElevatedButton(
                                        ...
                                        buttonStyle:
                                            CustomButtonStyles.fillPrimaryTL9,
                                                                              ...
                                                                              Align(
                                                                                  ...
                                                                                  child: Container(
                                                                                      ...
                                                                                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                        ...
                                                                                        SizedBox(height: 7.v),
                                                                                        Text("Curd Pouch", style: theme.textTheme.labelLarge),
                                                                                        Container(
                                                                                            width: 125.h,
                                                                                            ...
                                                                                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                                                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                                ...
                                                                                                SizedBox(height: 1.v),
                                                                                                Text("₹60", style: CustomTextStyles.bodySmall12_1),
                                                                                                Text("₹80", style: CustomTextStyles.bodySmallBluegray400)
                                                                                              ]),
                                                                                              Container(margin: EdgeInsets.only(top: 16.v, bottom: 3.v), padding: EdgeInsets.symmetric(horizontal: 10.h, vertical: 2.v), decoration: AppDecoration.outlineGreenA.copyWith(borderRadius: BorderRadiusStyle.roundedBorder4), child: Text("ADD", style: CustomTextStyles.labelLargeOnPrimary_2))
                                                                                            ]))
                                                                                      ])))
                                                                            ])))),
                                                        Align(
                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child: RichText(
                                                                              text: TextSpan(children: [
                                                                                ...
                                                                                TextSpan(text: " with", style: theme.textTheme.bodySmall)
                                                                              ]),
                                                                      ...
                                                                      Row(
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                                ...
                                                                                child: Text("ADD", style: CustomTextStyles.labelLargeOnPrimary_2))
                                                                          ])
                                                                    ]))),
                                                        Align(
                                                            alignment: Alignment
                                                                ...
                                                                Row(children: [
                                                                  ...
                                                                  Container(
                                                                      ...
                                                                      child: Text(
                                                                          "ADD",
                                                                          style:
                                                                              CustomTextStyles.labelLargeOnPrimary_2))
                                                                ])
                                                              ]))),
                                                  Align(
                                                      alignment: Alignment
